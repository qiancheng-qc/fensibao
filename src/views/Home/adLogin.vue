<template>
  <div class="login-model">
    <div class="login_screen login_logo">
      <div class="left">
        <router-link to="/">
          <span class="title">广告商家客户资源管理系统&nbsp;|&nbsp;CRM</span>
        </router-link>
      </div>
    </div>
    <div class="login-content">
      <div class="login-inner">
        <div class="login-left">
          <p>为您打造专属私域客群</p>
          <span>For Your Exclusively Customer Group</span>
          <div class="left-pic"></div>
        </div>
        <div class="login-form">
          <div class="form-title">广告商登录</div>
          <el-form
            :model="ruleForm"
            :rules="rules"
            ref="ruleForm"
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          window.location.href =
            ...
            "&password=" +
            this.ruleForm.newPass + '&userType=3';
        } else {
