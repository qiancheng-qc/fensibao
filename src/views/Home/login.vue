<template>
  <div class="login-model">
    <div class="login_screen login_logo">
      <div class="left">
        <router-link to="/">
          <span class="title">广告运营商家客户资源管理系统&nbsp;|&nbsp;CRM</span>
        </router-link>
        <!-- <i></i>
        <span>广告主推广平台</span> -->
      </div>
      <div class="right">
        <!-- <router-link class="tolink" to="">短视频商业价值</router-link> -->
      </div>
    </div>
    <div class="login-content">
      <div class="login-inner">
        ...
        <div class="login-form">
          <div class="form-title">运营商登录</div>
          <el-form
            :model="ruleForm"
            :rules="rules"
            ref="ruleForm"
          ...
          >
            ...
            >
              <el-input
                ...
                placeholder="验证码"
              ></el-input>
              <!-- <img class="img-yzm" src="../../assets/yzm.png" alt="" />
            <span @click="changeother()">换一张?</span> -->
            </el-form-item>
            <el-form-item
              class="identify"
          ...
          <div class="form-bottom">
            <el-dropdown @command="dropdownClick">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item command="agencylogin">代理商登录</el-dropdown-item>
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          window.location.href =
            ...
            "&password=" +
            this.ruleForm.newPass + '&userType=4';
        } else {
...
.login-model {
  ...
  .login-content {
    // background-image: url(../../assets/dxp_login_banner.jpg);
    // background-image: url(../../assets/2DocG.jpg);
    ...
    .login-left {
      ...
      .left-pic {
        margin-top: 40px;
        background: url(../../assets/isv-banner.png) no-repeat center;
